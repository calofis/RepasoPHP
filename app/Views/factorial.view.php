    ...
    if(isset($resultado)){ ?>
     <div class="col-12">
        <div class="alert alert-success">
            El resultado del factorial es: <?php echo $resultado; ?>
        </div>
    </div>
    <?php
    }
            ...
            <div class="card-body">
                ...
                <form method="post" action="">                    
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="numero" type="text" name="numero" placeholder="1..20" value="<?php echo isset($input['numero']) ? $input['numero'] : ''; ?>"> 
